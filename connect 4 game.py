import pygame, numpy, random, time, model
    ...
    for row in range(ROW_COUNT):
        for col in range(COLUMN_COUNT):
            ...
            if win_detection(1): #win schrift
                screen.blit(pygame.font.Font(None, 120).render("ROT GEWINNT", True, (255, 100, 100)), (PADDING, SCREEN_HEIGHT // 3))
            elif win_detection(2):
                screen.blit(pygame.font.Font(None, 120).render("GELB GEWINNT", True, (255, 255, 80)), (PADDING, SCREEN_HEIGHT // 3))
